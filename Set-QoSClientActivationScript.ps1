...
# Create QoS Policys
New-NetQosPolicy -Name "SkypeOnlineClientAudio" -AppPathName "lync.exe" -IPProtocol Both -IPSrcPortStart 50000 -IPSrcPortEnd 50019 -DSCPValue 46

New-NetQosPolicy -Name "SkypeOnlineClientVideo" -AppPathName "lync.exe" -IPProtocol Both -IPSrcPortStart 50020 -IPSrcPortEnd 50039 -DSCPValue 34

New-NetQosPolicy -Name "SkypeOnlineClientSharing" -AppPathName "lync.exe" -IPProtocol Both -IPSrcPortStart 50040 -IPSrcPortEnd 50059 -DSCPValue 24

New-NetQosPolicy -Name "SkypeOnlineClientFileTransfer" -AppPathName "lync.exe" -IPProtocol Both -IPSrcPortStart 50040 -IPSrcPortEnd 50059 -DSCPValue 24
